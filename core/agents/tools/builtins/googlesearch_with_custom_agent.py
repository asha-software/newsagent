...
# Original source here https://github.com/Nv7-GitHub/googlesearch modified by Shawn Joseph 03/28/2025 to add custom user agent support
...
def search(
    ...
    start_num=0,
    unique=False,
    # Added user agent input arg
    user_agent=googlesearch.get_useragent(),
):
